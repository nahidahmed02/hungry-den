...
const Credentials = () => {
    ...
    return (
        <div className="collapse collapse-arrow mt-5 mx-9 md:mx-16 lg:mx-44 bg-black rounded-lg border border-yellow-500">
            <input type="checkbox" />
            <div className="collapse-title font-semibold text-center text-orange-500">
            ...
            <div className="collapse-content flex justify-between md:justify-around lg:justify-around text-gray-200">
                <div>
                    <h2 className='font-semibold text-sm md:text-base lg:text-base text-orange-500'>Admin</h2>
                ...
                <div>
                    <h2 className='font-semibold text-sm md:text-base lg:text-base text-orange-500'>Delivery Man</h2>
