        ...
        <section className='pt-24 min-h-screen'>
            <div className='lg:flex lg:justify-center'>
                ...
                <div className='lg:w-96'>
                    <h2 className='border-b-2 border-b-custom-500 mt-8 -mb-20 mx-16 md:mx-24 lg:mx-16'></h2>
                    <h2 className='header-font text-4xl w-fit mx-auto px-3 md:px-5 lg:px-5 mt-14 mb-10 text-custom-500 bg-black'>Login</h2>
                    ...
                    <form onSubmit={handleSubmit(handleLogin)} className='flex flex-col w-96 mx-auto mb-4'>
                        ...
                        <input
                            ...
                            className="input input-bordered text-custom-500 border-custom-500 shadow shadow-gray-200 bg-transparent w-full max-w-xs mx-auto mb-3"
                            required
                        />
                        ...
                        <button
                            type="submit"
                            className="bg-custom-500 text-gray-200 shadow shadow-gray-200 font-semibold w-full max-w-xs mx-auto py-2 rounded-md hover:rounded-2xl">

                            Login
                        </button>

                        {loginError && <p className='text-custom-500 ml-10 pr-5 my-1 font-semibold'>{loginError}</p>}
