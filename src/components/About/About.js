...
const About = () => {
    return (
        <section className='pt-24 mb-16'>
            ...
            <h2 className='border-b-2 border-b-orange-500 mt-8 -mb-20 mx-12 md:mx-24 lg:mx-56'></h2>
            <h2 className='header-font text-4xl w-fit mx-auto px-3 md:px-5 lg:px-5 mt-14 mb-10 text-orange-500 bg-black'>Who We Are</h2>
