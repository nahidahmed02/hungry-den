        ...
        <section>
            ...
            <div className="mx-8 lg:mx-auto card w-auto lg:w-96 bg-base-100 shadow-2xl border">
                ...
                <div className="card-body">
                    ...
                    <p className='font-semibold'>Phone: <span className='font-normal'>{profile ? profile[0]?.phone : ''}</span></p>
                    <p className='font-semibold'>Address: <span className='font-normal'>{profile ? profile[0]?.address : ''}</span></p>
